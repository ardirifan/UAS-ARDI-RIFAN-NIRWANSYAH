            ...
            <div class="lg:col-span-2 space-y-8">
                ...
                <section class="bg-white rounded-xl shadow-md overflow-hidden">
                    <div class="p-6 bg-gray-800">
                        <h3 class="text-white font-bold flex items-center">
                            <i class="fas fa-table mr-2"></i> Screenshot Pivot Table
                        </h3>
                    </div>
                    <div class="p-6 text-center">
                         <img src="C:\Users\user\Pictures\Screenshots\Screenshot (218)" alt="Pivot Table Analysis" class="rounded-lg border border-gray-200 shadow-sm hover:scale-[1.02] transition-transform duration-300 mx-auto">
                ...
                <section class="bg-white rounded-xl shadow-md p-8">
                    <h3 class="text-2xl font-bold text-gray-900 mb-6 flex items-center border-b pb-4">
                        <i class="fas fa-lightbulb text-yellow-500 mr-3"></i> Interpretasi Hasil
                    </h3>
