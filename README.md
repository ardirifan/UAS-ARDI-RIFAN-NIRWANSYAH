            ...
            <div class="lg:col-span-2 space-y-8">
                ...
                <section class="bg-white rounded-xl shadow-md overflow-hidden">
                    ...
                    <div class="p-6 text-center">
                         <img src="screenshotss/Screenshot (218).png" alt="click here coba" class="rounded-lg border border-gray-200 shadow-sm hover:scale-[1.02] transition-transform duration-300 mx-auto">
